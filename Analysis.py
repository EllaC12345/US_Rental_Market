...
#%%
## Read the csv files
file_name = '/Users/ellandalla/Desktop/Portfolio/Unsupervised/US_Rental_Market/Raw_data/apartments_for_rent_classified_100K.csv'
...
from sqlalchemy import create_engine, Column, Integer, String, Float, Text, Numeric, DateTime
...
snip_df.to_sql('predictions', connection, if_exists='replace', index=False)

result = pd.read_sql('predictions', con=engine)
print(result)
#%%
